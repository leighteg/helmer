...
impl AtmosphereLuts {
    fn new(device: &wgpu::Device) -> Self {
        ...
        let scattering_lut_view = scattering_lut.create_view(&Default::default());
...
impl AtmospherePrecomputer {
    pub fn new(device: &wgpu::Device) -> Self {
        ...
        let scattering_bgl = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
    ...
    pub fn precompute(
        ...
        // Pass 1: Transmittance
        {
            ...
            cpass.set_bind_group(0, &self.transmittance_bg, &[]);
            cpass.dispatch_workgroups(TRANSMITTANCE_LUT_WIDTH / 8, TRANSMITTANCE_LUT_HEIGHT / 8, 1);
        }
        ...
        // Pass 2: Scattering
        {
            ...
            cpass.set_pipeline(&self.scattering_pipeline);
            cpass.set_bind_group(0, &self.scattering_bg, &[]);
        ...
        // Pass 3: Irradiance
        {
            ...
            cpass.set_bind_group(0, &self.irradiance_bg, &[]);
            cpass.dispatch_workgroups(IRRADIANCE_LUT_WIDTH / 8, IRRADIANCE_LUT_HEIGHT / 8, 1);
        }
    }
}
