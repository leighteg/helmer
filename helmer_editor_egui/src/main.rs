...
fn editor_init(
    ...
    world.insert_resource(EditorGizmoSnapSettings::default());
    ...
    if let Some(system_profiler) = world.get_resource::<BecsSystemProfiler>() {
        system_profiler.register_systems(&[
            ...
            "helmer_editor_egui::editor::asset_scan_system",
            "helmer_editor_egui::editor::drag_drop_system",
            "helmer_editor_egui::editor::editor_shortcut_system",
            "helmer_editor_egui::editor::scene_dirty_system",
            "helmer_editor_egui::editor::apply_scene_child_animations_system",
            "helmer_editor_egui::editor::apply_scene_child_pose_overrides_system",
            "helmer_editor_egui::editor::pending_scene_child_renderer_system",
            "helmer_editor_egui::editor::pending_skinned_mesh_system",
            "helmer_editor_egui::editor::script_registry_system",
            "helmer_editor_egui::editor::script_execution_system",
            "helmer_editor_egui::editor::editor_layout_apply_system",
            "helmer_editor_egui::editor::editor_ui_system",
            "helmer_editor_egui::editor::pane_manager_toggle_system",
            "helmer_editor_egui::editor::editor_layout_update_system",
            "helmer_editor_egui::editor::editor_layout_save_system",
            "helmer_editor_egui::editor::timeline_playback_system",
            ...
            "helmer_editor_egui::editor::gizmo_system",
            "helmer_editor_egui::editor::editor_render_refresh_system",
            "helmer_editor_egui::editor::selection_system",
            "helmer_editor_egui::editor::editor_undo_request_system",
            "helmer_editor_egui::editor::freecam_system",
        ]);
    }
