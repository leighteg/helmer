...
impl RenderGraphConfigSignature {
    pub fn from_render_config(cfg: &RenderConfig) -> Self {
        Self {
            ...
            ddgi_pass: cfg.ddgi_pass,
            transparent_pass: cfg.transparent_pass,
            ddgi_probe_count_x: cfg.ddgi_probe_count_x,
            ddgi_probe_count_y: cfg.ddgi_probe_count_y,
            ddgi_probe_count_z: cfg.ddgi_probe_count_z,
            ddgi_probe_resolution: cfg.ddgi_probe_resolution,
            rt_reflections: cfg.rt_reflections,
            egui_pass: cfg.egui_pass,
            gizmo_pass: cfg.gizmo_pass,
            sprite_pass: cfg.sprite_pass,
            ui_pass: cfg.ui_pass,
            sprite_picking: cfg.sprite_picking,
...
pub struct RenderGraphBuildParams {
    ...
    pub depth_copy_format: wgpu::TextureFormat,
    pub max_color_attachments: u32,
    pub force_low_color_formats: bool,
    pub supports_fragment_storage_buffers: bool,
...
/// Runtime provider for render graph templates.
/// GraphRenderer depends on this interface rather than concrete template modules.
pub trait RenderGraphTemplateCatalog: Send + Sync {
    fn default_spec(&self) -> RenderGraphSpec;
    fn template_spec(&self, name: &str) -> Option<RenderGraphSpec>;
}
