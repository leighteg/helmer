...
use crate::graphics::{
    ...
    common::{
        ...
        renderer::{
            MeshDrawParams, MeshTaskTiling, ShadowInstanceRaw, mesh_shader_visibility,
...
impl RenderPass for ShadowPass {
    ...
    fn execute(&self, ctx: &mut RenderGraphExecCtx) {
        ...
        let supports_shadow_bindings = frame.device_caps.supports_vertex_storage()
        ...
        let mesh_draw_enabled = supports_shadow_bindings
            && frame.render_config.shadow_pass
            && has_materials
        ...
        let clear_only = !supports_shadow_bindings
            || !frame.render_config.shadow_pass
            || !has_materials
